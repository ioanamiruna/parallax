 ...
 */
export declare type AnimationValueMap = (number | string)[] | {
 ...
 * See a list of available special values [here](https://github.com/alexfoxy/lax.js#special-values).
 */
export declare type DriverValueMap = (number | string)[];
export declare type LaxValue = [DriverValueMap, AnimationValueMap, LaxValueOptions?];
...
declare function useLax({ drivers, elements }?: LaxInitOptions): void;
declare function useLaxElement({ animationData, options, }?: Omit<LaxElement, 'selector'>): React.MutableRefObject<any>;
